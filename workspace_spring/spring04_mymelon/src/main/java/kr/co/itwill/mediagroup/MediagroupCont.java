...
public class MediagroupCont {
	...
	public MediagroupCont() {
		System.out.println("---------2--MediagroupCont() 객체 생성됨");
	}// end
	...
	public ModelAndView list() {
		...
		int totalRowCount=dao.totalRowCount(); // 총 글 갯수
	...
	public ModelAndView deleteForm(int mediagroupno) {
		...
		//mav.addObject("meidagroupno", mediagroupno); 오타
	...
	public ModelAndView deleteProc(int mediagroupno) {
		...
		if(cnt==0) {
			...
			String img 	 = "<img src='../images/fail.png'>";
			String link1 = "<input type='button' value='다시시도' onclick='javascript:history.back()'>";
			String link2 = "<input type='button' value='그뭅목록' onclick='location.href=\"./list.do\"'>";
		...
		//	mav.addObject("link2", "<input type='button' value='그뭅목록' onclick='location.href=\"./list.do\"'>");
