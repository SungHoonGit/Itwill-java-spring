...
<body>
	...
	<form name='frm' method='POST' action='update.do' enctype="multipart/form-data" onsubmit="return pdsCheck2()">
		<!-- 부모글번호(음원목록을 유지하기 위해) -->
        ...
        <tr>
          ...
          <td>
          	...
          	<input type='file' id="poster"  name='posterMF' size='50' >
          </td>    
        </tr>
        <tr>
          <th>미디어 파일</th>
          <td>
          	...
          	<input type='file' id="filename" name='filenameMF' size='50'>
          </td>    
        </tr>  
        </table>
