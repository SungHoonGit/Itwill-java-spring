...
public class ProductCont {
	...
	public String insert(@RequestParam Map<String, Object> map
		...
		if(img != null && !img.isEmpty()) {
			...
			try {
				...
				//D:\java202202\workspace_spring\spring09_fileupload\src\main\ebapp\storage
	...
	public ModelAndView search(@RequestParam(defaultValue = "")String product_name) {
		...
		mav.addObject("product_name",product_name);	// 검색어 보존
		return mav;
	}// search()
	...
	public String update(@RequestParam Map<String, Object> map
		...
		if(img != null && !img.isEmpty()) {
			...
			try {
				...
				//System.out.println(path);
				//D:\java202202\workspace_spring\spring09_fileupload\src\main\webapp\storage
