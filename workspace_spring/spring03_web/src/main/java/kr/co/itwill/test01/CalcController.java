...
public class CalcController {
	...
	public CalcController() {
		System.out.println("----------CalcController() 객체 생서성됨");
	}// end
	...
	public ModelAndView add(HttpServletRequest req) {
		...
		// application.properties환경설정의 prefix와 suffix 참조
		...
		req.setAttribute("img", "<img src='images/new.gif'>");
	...
	public ModelAndView sub(HttpServletRequest req) {
		...
		req.setAttribute("img", "<img src='images/reply.gif'>");
	...
	public ModelAndView mul(HttpServletRequest req, HttpServletRequest resp, HttpSession session) { 
		int no1=Integer.parseInt(req.getParameter("no1"));
		int no2=Integer.parseInt(req.getParameter("no2"));
		int result=no1*no2;
		...
		req.setAttribute("img", "<img src='images/hot.gif'>");
	...
	public ModelAndView div(HttpServletRequest req) {
		...
		req.setAttribute("img", "<img src='images/yellowstar.png'>");
