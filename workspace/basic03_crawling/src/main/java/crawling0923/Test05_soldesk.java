...
public class Test05_soldesk {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String URL = "https://soldesk.com/board/board_bagic/board_list.asp?scrID=0000000173";
				//&pageNum=8&subNum=1&ssubNum=1&page=1&bd_num=&act=list&s_string=
			for(int p=1; p<=8; p++) {
				String params= "&pageNum=8&subNum=1&ssubNum=1&page=" + p +"&bd_num=&act=list&s_string=";
