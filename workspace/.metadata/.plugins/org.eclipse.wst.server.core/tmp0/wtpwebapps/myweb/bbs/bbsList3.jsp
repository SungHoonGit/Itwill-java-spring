...
<%
   ...
   ArrayList<BbsDTO> list=dao.list3(col, word, nowPage, recordPerPge);//함수 호출 안함 (코드 누락)
   if(list==null){
      out.println("<tr>");
...
<%
      ...
      String paging=new Paging().paging3(totalRecord, nowPage, recordPerPge, col, word, "bbsList.jsp");
      out.print(paging);
      out.println("  </td> ");
      out.println(" </tr> ");
...
%>
      ...
      <tr>
        <td colspan="4" style='text-align: center; height: 50px;'>
          <form action="bbsList.jsp" onsubmit="return seachCheck()"><!-- myscript.js 함수 작성 -->
            <select name="col">
