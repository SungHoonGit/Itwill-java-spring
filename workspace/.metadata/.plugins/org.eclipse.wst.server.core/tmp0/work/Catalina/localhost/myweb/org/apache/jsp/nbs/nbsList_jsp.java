 ...
 * Generated at: 2022-10-31 09:06:31 UTC
...
public final class nbsList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/nbs/../member/auth.jsp", Long.valueOf(1666058516675L));
    _jspx_dependants.put("/nbs/../member/../../footer.jsp", Long.valueOf(1665462013456L));
    _jspx_dependants.put("/nbs/../member/../header.jsp", Long.valueOf(1666831450311L));
...
// 한 페이지당 출력할 행의 갯수
	...
	dto=list.get(i);
      ...
      out.write("										\r\n");
      out.write("					<a href=\"nbsRead.jsp?nbsno=");
      out.print(dto.getNbsno());
      out.write("&col=");
      out.print(col);
      out.write("&word=");
      out.print(word);
...
/*		out.println("<tr>");
      ...
      out.write("				<form action=\"nbsList.jsp\" onsubmit=\"return searchCheck()\"><!-- myscript.js 함수 작성함 -->\r\n");
...
if(s_mlevel.equals("A1")){ 
      out.write("\r\n");
      out.write("					<input type=\"button\" style=\"float: right;\" class=\"btn btn-primary\" onclick=\"location.href='nbsForm.jsp'\" value=\"글쓰기\">\r\n");
      out.write("					");
      }//if end  
      out.write("\r\n");
      out.write("				</form>\r\n");
