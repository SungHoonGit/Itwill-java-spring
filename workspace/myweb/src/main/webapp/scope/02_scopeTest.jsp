...
--%>
 ...
 %>
 	...
 	<form action="02_scopeResult.jsp">
 	 ...
 	 <!-- 3) request.getAttribute("tow") null 값 --> -->
 	 <!-- 
 	 <script>
...
<%
	//5) request.getAttribute("tow") null 값
