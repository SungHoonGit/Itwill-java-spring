...
<%
	...
	String sspwd =(String)session.getAttribute("s_passwd");	
	dto=dao.read(id);
	   if(dto==null){
		      out.println("해당 글 없음!!");
		   }else{
%>
<form name="memfrm" id="memfrm" action="memberModifyProc.jsp" onsubmit="return memberUpdateCheck()"><!-- myscript.js -->
<span style="color:red; font-weight: bold">* 필수입력 *</span>
<input type="hidden" name="id" id="id" value="<%=id%>" >
<input type="hidden" name="sspwd" id="ppswd" value="<%=sspwd%>" >
<br>
<table class="table">
	<tr>
		<th>*아이디</th>
	...
	<tr>
	    <th>*현재 비밀번호</th>
	    <td style="text-align: left"><input type="password" name="spasswd" id="spasswd" size="15" required ></td>
	</tr>
	<tr>
	    <th>*비밀번호</th>
	...
	<tr>  
	  <th>직업</th>
	  <td style="text-align: left">
	        <select name="job"  id="job" value="<%=dto.getClass()%>">
